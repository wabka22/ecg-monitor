...
//   if (!WiFi.softAP("ESP32_AD8232_Streamer", "12345678")) {
...
//   activeClient.println(String(sensorValue));
...
//     Serial.println("Starting AD8232 data stream");
//     client.println("OK");
//     client.flush();
//     isStreaming = true;
//     activeClient = client;
